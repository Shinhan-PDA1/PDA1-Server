...
public class InfoConnectorUriBuilderService {
    private static final String DETAIL_INFO_URL =  "jootopia-infoconnector.shinhansec-pda.net/api/v1/zootopia/detail";
    private static final String CHATBOT_URL =  "jootopia-infoconnector.shinhansec-pda.net/api/v1/openai/chatbot";
    private static final String GUIDE_URL =  "jootopia-infoconnector.shinhansec-pda.net/api/v1/zootopia/guide";
    private static final String STOCK_CODE_URL =  "jootopia-infoconnector.shinhansec-pda.net/api/v1/zootopia/search";
